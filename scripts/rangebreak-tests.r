...
setwd("/home/tcm0036/distichus-ddRAD/distichus-spatial-variation")
...
K1K2.rbb <- rangebreak.blob(species.1 = K1, species.2 = K2, type = "mx", nreps = 1000)
    png("niche-assessment/K_1_2_rbb.png")
        plot(K1K2.rbb)
    dev.off()
    save(K1K2.rbb, file = "niche-assessment/K1_K2.rbb")

## Eastern A. d. dominicensis vs A. d. ignigularis
K1K3.rbb <- rangebreak.blob(species.1 = K1, species.2 = K3, type = "mx", nreps = 1000) 
    png("niche-assessment/K_1_3_rbb.png")
        plot(K1K3.rbb)
    dev.off()
    save(K1K3.rbb, file = "niche-assessment/K1_K3.rbb")

## A. d. ignigularis vs A. d. properus
K3K5.rbb <- rangebreak.blob(species.1 = K3, species.2 = K5, type = "mx", nreps = 1000)
...
K3K4.rbb <- rangebreak.blob(species.1 = K3, species.2 = K4, type = "mx", nreps = 1000)
...
K4K2.rbb <- rangebreak.blob(species.1 = K4, species.2 = K2, type = "mx", nreps = 1000)
