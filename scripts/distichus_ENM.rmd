...
M_dir <- paste0(working_dir, "/data/occurrences/") # Add where you want unfiltered occurrences to go 
dir.create(M_dir)
...
write_csv(occs, "data/occurrences/filtered_distichus_occurrences.csv")
...
create_M(dom_1_4_occ_thinned, "dominicensis_1_4")
create_M(dom_2_occ_thinned, "dominicensis_2")
create_M(fav_occ_thinned, "favillarum")
create_M(tiburon_occ_thinned, "Tiburón_subspecies")
create_M(ignig_occ_thinned, "ignigularis")
create_M(prop_occ_thinned, "properus")
create_M(rav_occ_thinned, "ravitergum")
