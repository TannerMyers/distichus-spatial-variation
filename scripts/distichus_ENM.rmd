...
for (dir in dirs){
    ...
    var_folder <- paste0("enm/calibration-areas/", dir) 
    out_folder <- paste0("enm/PCA_variables/", dir)
    in_format <- "ascii" 
    out_format <- "ascii"
    scalev <- TRUE
    ...
    pcs <- kuenm_rpca(variables = var_folder, in.format = in_format, var.scale = scalev, 
