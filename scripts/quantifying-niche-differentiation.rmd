...
# Load functions
load("scripts/fill.NA.r")
load("scripts/trim.occ.r")
load("scripts/mo.metric.r")
load("scripts/rtr.r")
load("scripts/rtr.bias.r")
load("scripts/rtr.bias.map.r")
load("scripts/RTRsignificance.r")
```
...
First, I have to create ENMTools species objects:
```{r}
