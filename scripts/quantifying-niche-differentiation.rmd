...
# Use fauxcurrence package to obtain background points that have been adjusted for spatial sampling bias.
```{r}
...
```{r}
K1_2 <- background.test(species.1 = K1, species.2 = K2, env = env2, type = "mx", test.type = "symmetric", nreps = 100, bg.source = "points")
