...
```{r, eval=FALSE}
occ_joint <- "~/Dropbox/Distichus_Project/distichus-spatial-project/sdm/Model_calibration/All_Records_30km_thin/Adist1_all.csv" # All occurrences
occ_tra <- "~/Dropbox/Distichus_Project/distichus-spatial-project/sdm/Model_calibration/All_Records_30km_thin/Adist1_train.csv" # calibration occurrences
M_var_dir <- "~/Dropbox/Distichus_Project/distichus-spatial-project/sdm/M_variables/"
batch_cal <- "Candidate_models"
out_dir <- "~/Dropbox/Distichus_Project/distichus-spatial-project/sdm/Candidate_Models/A_distichus_all"
reg_mult <- c(seq(0.1, 1, 0.1), seq(2, 6, 1), 8, 10)
f_clas <- "all"
args <- NULL
maxent_path <- "~/maxent/maxent.jar"
wait <- FALSE
run <- TRUE
```
